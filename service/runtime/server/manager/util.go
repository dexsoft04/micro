...
func (m *manager) runtimeEnv(srv *gorun.Service, options *gorun.CreateOptions) []string {
	...
	env := map[string]string{
		...
		"MICRO_POSTGRESQL_ADDRESS": os.Getenv("MICRO_POSTGRESQL_ADDRESS") + "/" + srv.Metadata["namespace"],
		"MICRO_MONGODB_ADDRESS": os.Getenv("MICRO_MONGODB_ADDRESS") + "/" + srv.Metadata["namespace"] + "?authSource=admin",
	}
