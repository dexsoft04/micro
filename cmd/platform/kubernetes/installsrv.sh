...
if [ $MICRO_ENV == "dev" ]; then
  sed -i '' 's/mcbeam-dev:mcbeam-dev-20210908-8a87da28e966a90b00ca82e3dd24c073ff5e4552/mcbeam-dev:mcbeam-dev-20210909-6ba47d91d11bd40f98fd5adc4dda48ce73d8150f/g' `ls ./service/*`
